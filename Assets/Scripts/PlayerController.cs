...
public class PlayerController : MonoBehaviour
{
    ...
    public Text coins;
    private int coinsInitial = 0;
    private AudioSource audioPlayer;

    void Start(){
        audioPlayer = this.GetComponent<AudioSource>();
        coins.text = "Coins:" + coinsInitial; 
    ...
    private readonly float m_backwardRunScale = 4f;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if(collision.gameObject.tag == "coin"){
            ...
            audioPlayer.PlayOneShot(collectCoins);
            coinsInitial += 1;
            coins.text = "Coins:" + coinsInitial;
        }
    ...
    void Update(){
        ...
        if(secondsCount > 7){
            audioPlayer.PlayOneShot(timeout);
